...
public abstract class AbstractFrameTransferSceneProcessor<T extends Node> implements FrameTransferSceneProcessor {
     ...
     * The JME application.
     */
    private volatile JmeEngineService application;
     ...
     */
    protected JmeEngineService getApplication() {
        return application;
    }
     ...
     */
    protected void setApplication(JmeEngineService application) {
     ...
     * @param application the application.
     */
    public void bind(T destination, JmeEngineService application) {
     ...
     */
    public void bind(T destination, JmeEngineService application, ViewPort viewPort) {
     ...
     */
    public void bind(T destination, JmeEngineService application, Node inputNode) {
